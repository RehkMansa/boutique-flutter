      ...
      body: ListView(
        children: [
          ListTile(
            ...
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => NetWorkPrinterScreen()));
            },
          ),
          ListTile(
            title: Text("Bluetooth Printer (android, ios:ble)"),
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => BluetoothPrinterScreen()));
            },
          ),
          ListTile(
            title: Text("USB Printer (desktop:windows, android)"),
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => USBPrinterScreen()));
            },
          ),
        ],
      ),

...
<head>
    ...
    <title>SALE INVOICE</title>
		...
		* {
		  ...
		  #invoice-POS {
		  <!-- box-shadow: 0 0 10px -0.25px rgba(0, 0, 0, 0.5); -->
		  padding: 1em;
		  width:100%;
		  background: #FFF;
		}
    ...
    <div id="invoice-POS">
      ...
      <div id="mid">
        <div class="info">
          <h3>Contact Info</h3>
          <p> 
              Address : Shop 26 Tonimas, state Awka</br>
            ...
            <div id="table">
              <table>
                ...
                <tr class="service">
                  ...
                  <td class="tableitem"><p class="itemtext">N375.00</p></td>
                </tr>
  
                <tr class="service">
                  <td class="tableitem"><p class="itemtext">3</p></td>
                  <td class="tableitem"><p class="itemtext">Asset Gathering</p></td>
                  <td class="tableitem"><p class="itemtext">N225.00</p></td>
                </tr>
                ...
                <tr class="service">
                  ...
                  <td class="tableitem"><p class="itemtext">N1500.00</p></td>
                </tr>
  
                <tr class="service">
                  <td class="tableitem"><p class="itemtext">10</p></td>
                  <td class="tableitem"><p class="itemtext">Animation Revisions in ation visions</p></td>
                  <td class="tableitem"><p class="itemtext">N750.00</p></td>
                </tr>
                ...
                <tr class="tabletitle">
                  ...
                  <td class="payment"><h4>N419.25</h4></td>
                </tr>
      ...
      <div id="bot">
            ...
            <div id="table">
              <table>
                ...
                <tr class="service">
                  <td class="tableitem">5</td>
                  <td class="tableitem">Communication</td>
                  <td class="tableitem">N375.00</td>
                </tr>
  
                <tr class="service">
                  <td class="tableitem">3</td>
                  <td class="tableitem">Asset Gathering</td>
                  <td class="tableitem">N225.00</td>
                </tr>
  
                <tr class="service">
                  <td class="tableitem">5</td>
                  <td class="tableitem">Design Development</td>
                  <td class="tableitem">N375.00</td>
                </tr>
  
                <tr class="service">
                  <td class="tableitem">20</td>
                  <td class="tableitem">Animation</td>
                  <td class="tableitem">N1500.00</td>
                </tr>
  
                <tr class="service">
                  <td class="tableitem">10</td>
                  <td class="tableitem">Animation Revisions in ation visions</td>
                  <td class="tableitem">N750.00</td>
                </tr>

...
//                   child: Text('Add SubCategory'.toUpperCase(), style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24)),
//                 ),
//                 Padding(
//                   padding: EdgeInsets.all(20),
//                   child: Container(
//                     width: Get.width,
//                     decoration: BoxDecoration(border: Border.all(color: Colors.black87), color: Colors.white, borderRadius: BorderRadius.circular(10)),
//                     child: const Padding(
...
//                 Padding(
//                   padding: EdgeInsets.all(20),
//                   child: TextInputField(label: 'Subcategory', border: Border.all(color: Colors.black)),
//                 ),
